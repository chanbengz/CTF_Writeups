...
challenge_abi = compiled['SharingIsCaring.sol:SharingIsCaring']['abi']

# connect to Web3
w3 = Web3(Web3.HTTPProvider('http://ctf.mevsec.com:50286'))
...
challenge_addr = setup_contract.functions.sic().call()
challenge = w3.eth.contract(challenge_addr, abi=challenge_abi)


# payload
flag = challenge.functions.flag().call()
print(flag)
